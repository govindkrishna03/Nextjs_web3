    ...
    <div className="">
      ...
      <div className="mt-8 lg:ml-14 lg:mt-10 sm:justify-self-center lg:justify-self-start lg:place-self-center">
        ...
        >
          <div>
            <img
              className="w-[100vh] h-[17.25rem] justify-self-center sm:w-[26.25rem] sm:h-[20.25rem] md:w-[33.25rem] md:h-[25.25rem] lg:w-[38.25rem] lg:h-[28.25rem]"
              alt=""
          ...
          <div>
            <img
              ...
              alt=""
              src="https://media.istockphoto.com/id/1015934992/photo/establishing-shot-of-technologically-advanced-operating-room-with-no-people-ready-for-surgery.jpg?s=612x612&w=0&k=20&c=BX0eUA0ccfUKxpvqTWbaiF7K1KQMT-dp5lUs21CeZBE="
            />
          </div>
          <div>
            <img
